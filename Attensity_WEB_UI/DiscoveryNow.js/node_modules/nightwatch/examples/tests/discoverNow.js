/*
 * DiscoveryNow Web UI
 * Login --> Create Topic --> Delete Topic
 * 11 Test Cases
 *
...
exports.home=function(client) {
	client
	  .click(home)
	  .pause(5000)
};

exports.topicName2=function(client) {
	client
	  .useXpath()
	  .moveToElement(topicName2,10, 10)
	  .pause(3000)
};

exports.topicDeleteCancel=function(client) {
	client
	  ...
	  .pause(3000)
	  .click(topicDeleteCancelButton)
	  .pause(5000)
};

exports.topicName2a=function(client) {
	client
	  .useXpath()
	  .moveToElement(topicName2,10, 10)
	  .pause(3000)
