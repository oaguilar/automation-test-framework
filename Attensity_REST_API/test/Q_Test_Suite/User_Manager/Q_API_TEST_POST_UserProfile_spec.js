/* jasmine-node Q_API_TEST_POST_UserProfile_spec.js 
   ARTSA-xxxx
...
var automationAccountID = credentials.automationAccountID;
    ...
    frisby.create('POST User Profile')
		.post(xURL + restUser + '/profile',
{
    ...
    maxTopicLimit: 15
		...
		.expectStatus(200)
		.inspectJSON()
		.after(function() {console.log('=====>>>>>End Of POST User Profile<<<<<=====')})
		.toss();