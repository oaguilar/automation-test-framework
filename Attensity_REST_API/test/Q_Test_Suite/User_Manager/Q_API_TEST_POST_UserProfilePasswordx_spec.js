/* jasmine-node Q_API_TEST_POST_UserProfilePasswordx_spec.js 
   ARTSA-xxxx
...
var automationAccountID = credentials.automationAccountID;
    ...
    frisby.create('POST User Profile Passwordx')
		.post(xURL + restUser + '/profile/password',
{
    ...
    password: 'Admin1234'
		...
		.expectStatus(200)
		.inspectJSON()
		.after(function() {console.log('=====>>>>>End Of POST User Profile Passwordx<<<<<=====')})
		.toss();