/* jasmine-node POST_Articles_aggregateCompanySentimentSentiment_spec.js
   ARTSA-4967
...
var END_DT = em.unix();
		...
		frisby.create('POST Aggregate - Company Sentiment - Sentiment')
		...
		.expectStatus(200)
		.inspectJSON()
		.after(function() {console.log('=====>>>>>End Of POST Aggregate - Company Sentiment - Sentiment<<<<<=====')})
		.toss();	